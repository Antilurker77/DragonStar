// https://bitbucket.org/jacobalbano/sfml-richtext/overview
...
namespace sfe
{
		...
		RichText::initializeColors()
	{
		...
		// custom colors for dragon star
		colors["skill"] = sf::Color(200, 150, 0, 255);
		colors["spell"] = sf::Color(0, 200, 200, 255);
		colors["damage"] = sf::Color(225, 100, 0, 255);
		colors["heal"] = sf::Color(0, 200, 0, 255);

		colors["magical"] = sf::Color(30, 255, 0, 255);
		colors["rare"] = sf::Color(0, 110, 220, 255);
		colors["mythic"] = sf::Color(165, 55, 240, 255);
		colors["unique"] = sf::Color(255, 130, 0, 255);
		colors["relic"] = sf::Color(230, 0, 0, 255);
	}
